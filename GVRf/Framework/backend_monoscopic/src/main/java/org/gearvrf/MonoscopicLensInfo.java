 ...
 * {@link MonoscopicXMLParser}) and is used in {@link MonoscopicViewManager}.
 */
class MonoscopicLensInfo {
    ...
    /**
     * Constructs a MonoscopicLensInfo object with distortion data which requires a
     * valid, pre-processed MonoscopicXMLParser object
     * 
     ...
     * @param xmlParser
     *            other parameters holds in MonoscopicXMLParser
     */
    public MonoscopicLensInfo(int screenWidthPixels, int screenHeightPixels,
