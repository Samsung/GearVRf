 ...
 * {@link MonoscopicViewManager} calls MonoscopicXMLParser to initialize the distortion value
 * internally
 */
class MonoscopicXMLParser {
    /**
     * Constructs a MonoscopicXMLParser with current package assets manager and the
