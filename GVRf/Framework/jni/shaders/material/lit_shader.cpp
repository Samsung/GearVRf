...
LitShader::LitShader() :
        program_(0), a_position_(0), a_tex_coord_(0), a_normal_(0), u_mv_(0), u_mv_it_(
                0), u_mvp_(0), u_light_pos_(0), u_texture_(0), u_color_(0), u_opacity_(
                0), u_material_ambient_color_(0), u_material_diffuse_color_(0), u_material_specular_color_(
                0), u_material_specular_exponent_(0), u_light_ambient_intensity_(
                0), u_light_diffuse_intensity_(0), u_light_specular_intensity_(
                0) {
    ...
    u_material_ambient_color_ = glGetUniformLocation(program_->id(),
            "materialAmbientColor");
    u_material_diffuse_color_ = glGetUniformLocation(program_->id(),
            "materialDiffuseColor");
    u_material_specular_color_ = glGetUniformLocation(program_->id(),
            "materialSpecularColor");
    u_material_specular_exponent_ = glGetUniformLocation(program_->id(),
            "materialSpecularExponent");
    u_light_ambient_intensity_ = glGetUniformLocation(program_->id(),
            "lightAmbientIntensity");
    u_light_diffuse_intensity_ = glGetUniformLocation(program_->id(),
            "lightDiffuseIntensity");
    u_light_specular_intensity_ = glGetUniformLocation(program_->id(),
