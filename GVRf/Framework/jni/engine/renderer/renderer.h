...
private:
    ...
    static void occlusion_cull(std::shared_ptr<Scene> scene, std::vector < std::shared_ptr < SceneObject >> scene_objects);
    static void frustum_cull(std::shared_ptr<Scene> scene,
