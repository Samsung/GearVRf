 ...
 */
public class GVRMonoActivity extends Activity {

    private static final String TAG = Log.tag(GVRMonoActivity.class);

    private GVRMonoViewManager mGVRViewManager = null;
    ...
    public void setScript(GVRScript gvrScript, String distortionDataFileName) {
        if (getRequestedOrientation() == ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE) {
            mGVRViewManager = new GVRMonoViewManager(this, gvrScript,
