...
public abstract class GVRMain implements IScriptEvents, IScriptable, IEventReceiver {
    ...
    public enum SplashMode {
         ...
         * {@link GVRMain#onInit(GVRContext) onInit()} and hidden before the
         * first call to {@link GVRMain#onStep() onStep()}
         */
        AUTOMATIC,
        /**
         * The splash screen will be shown before
         * {@link GVRMain#onInit(GVRContext) onInit()} and will remain up
         * until you call {@link GVRMain#closeSplashScreen()}
         */
        MANUAL,
        /**
         * The splash screen will not be shown at all. The screen will go black
         * until your {@link GVRMain#onInit(GVRContext) onInit()} returns, at
