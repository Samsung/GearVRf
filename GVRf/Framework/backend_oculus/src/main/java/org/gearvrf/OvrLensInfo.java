 ...
 * {@link OvrXMLParser}) and is used in {@link OvrViewManager}.
 */
class OvrLensInfo {
    ...
    /**
     * Constructs a OvrLensInfo object with distortion data which requires a
     ...
     */
    public OvrLensInfo(int screenWidthPixels, int screenHeightPixels,
