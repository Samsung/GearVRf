...
package org.gearvrf.controls.gestures;
...
public class TouchPadGesturesDetector implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    TouchPadGesturesDetector.OnTouchPadGestureListener gestureListener;
    TouchPadGesturesDetector.OnTouchPadDoubleTapListener doubleTapListener;
    ...
    public interface OnTouchPadGestureListener {
         ...
         * @return true if the event is consumed, else false
         */
        abstract boolean onSwipe(MotionEvent e, SwipeDirection swipeDirection,
                float velocityX, float velocityY);

        abstract void onSwiping(MotionEvent e, MotionEvent e2,
                float velocityX, float velocityY, SwipeDirection swipeDirection);

        abstract void onSwipeOppositeLastDirection();
    }
    ...
    public TouchPadGesturesDetector(Context context, TouchPadGesturesDetector.OnTouchPadGestureListener listener) {
