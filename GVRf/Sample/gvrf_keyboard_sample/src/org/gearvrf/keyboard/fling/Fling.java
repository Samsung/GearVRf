...
public class Fling {
   ...
   private static final float timesAnimationRanger [] = new float []{1.5f, 2.6f, 3f, 2.3f, 1.6f, 1f};
  // private static final float timesAnimationRanger [] = new float   []{12f  , 10f  , 8f, 6f,   3f, 2f};
  //  private static final float timesAnimationRanger [] = new float   []{8f  , 6f  , 4f, 3f,   3f, 2f};
  //  private static final float timesAnimationRanger [] = new float   []{6f  , 4f  , 3f, 3f,   3f, 2f};
 //   private static final float timesAnimationRanger [] = new float   []{6f  , 4f  , 3f, 3f,   3f, 2f};
