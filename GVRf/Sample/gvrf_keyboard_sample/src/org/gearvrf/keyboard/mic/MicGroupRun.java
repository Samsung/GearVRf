...
public class MicGroupRun extends GVRSceneObject {
    ...
    public MicGroupRun(GVRContext gvrContext) {
        ...
        for (int i = 0; i < NUMBER_OF_WAVES; i++) {
            ...
            mMicRunItens[i].getRenderData().setRenderingOrder(RenderingOrder.ORDER_RENDERING_RUN - i);
        ...
        for (int i = 0; i < NUMBER_OF_WAVES; i++) {
            ...
            getGVRContext().getPeriodicEngine().runAfter(new Runnable() {
                ...
                public void run() {
                    ...
                    mOpacityAnimation[iterator] = new GVROpacityAnimation(mMicRunItens[iterator], ANIMATION_TIME, 0);
        ...
        for (int i = 0; i < NUMBER_OF_WAVES; i++) {
            ...
            getGVRContext().getPeriodicEngine().runAfter(new Runnable() {
                ...
                public void run() {
                    ...
                    mOpacityAnimation[iterator] = new GVROpacityAnimation(mMicRunItens[iterator], ANIMATION_TIME, 1);
                    mOpacityAnimation[iterator].setInterpolator(new InterpolatorExpoEaseOut());
        ...
        for (int i = 0; i < NUMBER_OF_WAVES; i++) {
            ...
            getGVRContext().getPeriodicEngine().runAfter(new Runnable() {
                ...
                public void run() {
                    ...
                    mScaleAnimation[iterator] = new GVRScaleAnimation(mMicRunItens[iterator], ANIMATION_TIME, 1);
